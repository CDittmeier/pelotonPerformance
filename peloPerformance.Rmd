...
Sys.setenv("PELOTON_LOGIN" = "UN")
Sys.setenv('PELOTON_PASSWORD' = 'pass')
...
for(i in 1:nrow(pel_workouts)) {
  ...
  pel_perf <- rbind(pel_perf,one_ride )
  ...
  mutate(type_emoji = case_when(
    str_detect(ride_title, "Cool Down") ~ paste("Cool down ", emo::ji("sweat")),
  ...
  mutate(average_output = total_work...19 / ride_pedaling_duration, total_output = total_work...19/1000)
...
```
<iframe src="https://giphy.com/embed/cZFGAMxGODG39fXbiE" width="480" height="300" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/onepeloton-cZFGAMxGODG39fXbiE">via GIPHY</a></p>
...
<iframe src="https://giphy.com/embed/vlcraP832v9Uj5yhCq" width="480" height="300" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/onepeloton-vlcraP832v9Uj5yhCq">via GIPHY</a></p>
...
<iframe src="https://giphy.com/embed/4KsPl3JpalRibfSngZ" width="480" height="300" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/onepeloton-4KsPl3JpalRibfSngZ">via GIPHY</a></p>
